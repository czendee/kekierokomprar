...
public class DataDescriptorKekikoTienda implements Serializable {
    private String id;
...
//    private String estaSiendoUtilizadoEsteUsuario;
    ...
    public DataDescriptorKekikoTienda(String id, String internalId, String name, String tipo, String manada, String porLon, String posAlt, String rentaTiempo, String rentaCosto, String transmite, String transmiteCanal) {
        super();
        this.id = id;
    ...
    public DataDescriptorKekikoTienda(){
