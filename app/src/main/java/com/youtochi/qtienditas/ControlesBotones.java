...
//  se cambio por table with rows
//  LinearLayout mRelLayout;//aqui flota el textEdit y su boton
      TableLayout mRelLayout;//aqui flota el textEdit y su boton

//    TableLayout mRelLayout02;//aqui flota el textEdit y su boton
...
//        wm.addView(mImgButtonIzq, paramsIzq);  //boton auxiliar, primer level
//        wm.addView(mImgButtonArriba, paramsTop); //boton auxiliar, primer level
//        wm.addView(mImgButtonDerecho, paramsDerecho); //boton auxiliar, primer level
        wm.addView(mImgButtonEnds, paramsCerrar); //boton de cerrar
        wm.addView(mImgButtonPeris, paramsPeris);  //boton pequeño al lado del princi
        wm.addView(mImgButtonPerso, paramsPerso);  //boton central
...
//                        paramsEditPeris.x = initialX - 280 -(int) (event.getRawX() - initialTouchX);
                        paramsEditPeris.x = initialX + 50 -(int) (event.getRawX() - initialTouchX);
                        paramsEditPeris.y = initialY +50- (int) (event.getRawY() - initialTouchY);
                        //Update the layout with new X & Y coordinate
                        wm.updateViewLayout(mRelLayout, paramsEditPeris);
 ...
 */
    public void defineBotonHijo01(){
        ...
        mImgButtonDerecho.setBackgroundResource(R.mipmap.ic_kekiko01_01_small);
...
*/
                    ...
                    mImgButtonPerso.setBackgroundResource(R.mipmap.ic_kekiko01_01_small);
                    wm.updateViewLayout(mImgButtonPerso, paramsPerso);
                }
                else{
                    //Do whatever you want during press
                    ...
                    mImgButtonPerso.setBackgroundResource(R.mipmap.ic_kekiko01_02_medium);
                    wm.updateViewLayout(mImgButtonPerso, paramsPerso);                }
                return true;
            }
        });
...
*/
    public void defineBotonHijo03(){
        ...
        mImgButtonIzq.setBackgroundResource(R.mipmap.ic_kekiko01_03_2_medium);
...
*/
                    ...
                    //Do whatever you want during press
                    mImgButtonIzq.setBackgroundResource(R.mipmap.ic_kekiko01_02_medium);
                    //Update the layout with new X & Y coordinate
                    wm.updateViewLayout(mImgButtonIzq, paramsIzq);
                }
                return true;
