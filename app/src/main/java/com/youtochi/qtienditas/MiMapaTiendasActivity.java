...
public class MiMapaTiendasActivity extends FragmentActivity implements GoogleMap.OnMarkerClickListener,OnMapReadyCallback, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(MiMapaTiendasActivity.this, "First enable LOCATION ACCESS in settings.", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        fabMode.setImageResource(R.mipmap.ic_kekiko01_01_small);
...
//                        .setAction("Action", null).show();
                ...
                if(Mode.equals("mapa")){
                    ...
                    if(tiendaDataBeingUsed!=null && tiendaDataBeingUsed.getTransmite()!=null && tiendaDataBeingUsed.getTransmite().equals("periscope")){
                        fabModeCambiarlo.setImageResource(R.mipmap.ic_bot_peris);
                    }else  if(tiendaDataBeingUsed!=null &&  tiendaDataBeingUsed.getTransmite()!=null && tiendaDataBeingUsed.getTransmite().equals("whatsapp")){
                        fabModeCambiarlo.setImageResource(R.mipmap.ic_bot_whats);
                    }else{
                        fabModeCambiarlo.setImageResource(R.mipmap.ic_kekiko01_02_medium);
                    }
                    ...
                    Mode="mapa";
                    fabModeCambiarlo.setImageResource(R.mipmap.ic_kekiko01_01_small);
...
//                    mTienda01.setPosition(new LatLng(point.latitude, point.longitude));
        ...
        fabArriba.setX(100);  //primero de arriba a abajo
        fabArriba.setY(200);

        fabAbajo.setX(100);    //second de arriba a abajo
        fabAbajo.setY(-300);


        fabDer.setX(-100);     //tercero de arriba a abajo
        fabDer.setY(-150);

        fabIzq.setX(400);     //cuarto, el de hasta abajo
        fabIzq.setY(10);

//initially set the buttons to be images rows
        fabArriba.setImageResource(R.mipmap.ic_bot_peris);//R.mipmap.arriba
        fabAbajo.setImageResource(R.mipmap.ic_bot_facelive);//R.mipmap.abajo
        fabIzq.setImageResource(R.mipmap.ic_bot_google);
        fabDer.setImageResource(R.mipmap.ic_bot_whats);
...
//END:define manager for sensor manager
    ...
    private  Marker mTienda05;
    private  Marker mTienda06;
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(mexicoCity));
        ...
        //tienda en villahermosa

        LatLng robotPosicion05 = new LatLng(18.051, -92.958);

        mTienda05= mMap.addMarker(
                new MarkerOptions().position(robotPosicion05).title("Ahora:DISPONIBLE - Coquito Villahermosa MEXICO - Tipo: (MuchasBolas)").snippet(" Renta por:(10mins) Renta $:(Gratis) Manada:(Si) Transmite Periscope:(Si)")
        );
        mTienda05.setIcon(bmd);
...
//  old 1      mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(mexicoCity,mMap.getMaxZoomLevel()-14)); //continente
//        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(dondeEstoyLatLon,mMap.getMaxZoomLevel()-10)); //nivel estado tabasco
//old 2        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(mexicoCity,mMap.getMaxZoomLevel()-4)); //nivel colonia
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(dondeEstoyLatLon,mMap.getMaxZoomLevel()-6)); //nivel zona
...
//            startService(new Intent(MiMapaTiendasActivity.this, ControlesBotones.class));
        ...
        if (marker.equals(mTienda05))
        {
            ...
            //CZ 09 Nov 2017:start
            //Open the floating controls in system
            System.out.println("onMarkerClick 05 paso conectar 1");
//            startService(new Intent(MiMapaTiendasActivity.this, ControlesBotones.class));
            ...
            Uri webpage = Uri.parse("https://www.pscp.tv/shockazooloo");
