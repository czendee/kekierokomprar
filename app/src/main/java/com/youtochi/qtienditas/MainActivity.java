...
//        setSupportActionBar(toolbar);
        ...
        sumaTotal=0;
        cuantosArticulos=0;
//boton que esta en la barra del mian screen, pero se oculto en content_main.xml
...
//        ListaProdServ adapter= new ListaProdServ(
        adapter= new ListaHistorial(
                MainActivity.this,
                web,
                imageId,
                new ArrayList<com.youtochi.qtienditas.DataDescriptorHistorial>()
        );
...
//            public boolean onItemLongClick(AdapterView<?> arg0,
            public void onItemClick(AdapterView<?> arg0,
                ...
                DataDescriptorHistorial robotAUtilizar= adapter.getItem(position);
...
//        task.parametroURL="http://mexico.brinkster.net/tochi_get_lista_habitaciones_rentadas_mobil.asp?operacion=lista&soy="+cualUsuarioSoy+"&mes="+mes;
        ...
        task.parametroURL=f.URL_LIST_HISTORIAL;
...
//        Log.i("Geo_Location", "Latitude: " + latitude + ", Longitude: " + longitude);
    ...
    private class AsyncListViewLoader extends AsyncTask<String, Void, List<DataDescriptorHistorial>> {
        ...
        @Override
        protected void onPostExecute(List<DataDescriptorHistorial> result) {
...
//            adpt.notifyDataSetChanged();
            ...
            //cylce through List Historial result, y ponerlo en lista de ArrayTask
            arrayTasks.clear();
            if(result!=null) {
                System.out.println("Lista Historial onPostExecute paso 2");
                for (DataDescriptorHistorial f : result) {
        ...
        @Override
        protected List<DataDescriptorHistorial> doInBackground(String... params) {

            System.out.println("PrimerFragment doInBackground paso 1");

            List<DataDescriptorHistorial> result = new ArrayList<DataDescriptorHistorial>();
...
//                JSONArray arr = jsonResponse.getJSONArray("edificio");
                ...
                for (int i=0; i < arr.length(); i++) {
                    result.add(convertIntoDataDescriptorHistorial(arr.getJSONObject(i)));
                }
        ...
        private DataDescriptorHistorial convertIntoDataDescriptorHistorial(JSONObject obj) throws JSONException {

            System.out.println("List convertHistorial paso 10");

            String id=obj.getString("id");
//            String internalid=obj.getString("internalid");
            String name=obj.getString("name");
            String tipo=obj.getString("tipo");
            String negocio=obj.getString("negocio");
            String posLon=obj.getString("lon");
            String posLat=obj.getString("lat");
            String precioOriginal=obj.getString("preciooriginal");
            String puntosPagados=obj.getString("puntospagados");
            String precioPagado=obj.getString("preciopagado");
            String ano=obj.getString("ano");
            String mes=obj.getString("mes");
            String dia=obj.getString("dia");
            String hora=obj.getString("hora");
            String minuto=obj.getString("minuto");
            String segundo=obj.getString("segundo");
            String imagenDesplegar=obj.getString("imagendesplegar");
            String videodesplegar=obj.getString("videodesplegar");


            System.out.println("List convertHistorial paso 11:"+name);
            System.out.println("List convertHistorial paso 12:"+tipo);

            return new DataDescriptorHistorial("01",id,name,tipo,  negocio,  posLon,  posLat,  precioOriginal,  puntosPagados,  precioPagado,
                    ano,mes,dia,hora,minuto,segundo, imagenDesplegar, videodesplegar);
